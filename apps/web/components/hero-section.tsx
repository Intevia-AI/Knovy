          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      Introducing AI Meeting Assistant
                    </span>
                ...
                >
                  Revamp your communication before, during, and after meetings
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  Power your meetings with your peronalized AI assistant. Help
                  you respond like a genius instantly.
                </TextEffect>
