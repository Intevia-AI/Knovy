      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16 lg:space-y-20 dark:[--color-border:color-mix(in_oklab,var(--color-white)_10%,transparent)]">
        ...
        <div className="relative z-10 mx-auto max-w-3xl space-y-6 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            ...
            <br />
            <br />
            因此，我們決定做一個結合會議面試兩者工具，不論是公司內部會議、學業報告討論、面試、客戶溝通都能適用，兼顧會議前、中、後，並且以工具列的形式呈現的全方位AI
            meeting
            Assistant。讓使用者僅需停留在原本視訊畫面，不需切換視窗及可在同個畫面使用工具。
          </p>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-3xl space-y-6 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            我們希望打造一個極致方便的。透過 INTEVIA AI，讓你彷彿拿到knowledge
            buff一樣，不論是開什麼會都有如神助，也減少不必要的多餘操作，讓你可以專心在會議本身。
            <br />
            <br />
            ...
            <br />
            <br />
            不只這樣，你還能事先上傳會議的相關文件、會議目標、議程給INTEVIA，他會在你開會中需要的時候及時跳出，再也不用自己翻文件。除此之外，INTEVIA也將包含real
            time
            的翻譯和字幕，還有口音的強化及修正，不論是哪國語言、哪種口音，都不用擔心有溝通障礙。
            <br />
            <br />
            最後，其他Meeting
            AI有的功能，我們也會有，包括會後的摘要、代辦事項、deadline和逐字稿。我們也會替你的會議表現、口才評分，給您最直接的建議。當然，要使用我們的AI去面試也沒有問題。
          </p>
        </div>
          ...
          <div className="grid gap-12 md:grid-cols-3">
            ...
            <div className="space-y-4 rounded-lg border bg-card p-6">
              ...
              <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
                <li>設定會議目標、主題、成員、氛圍</li>
                <li>上傳相關文件(文件、報告、履歷、職缺描述、新聞)</li>
                <li>設定語言與口音</li>
              </ul>
            </div>
            {/* During Meeting */}
            <div className="space-y-4 rounded-lg border bg-card p-6">
              <h3 className="text-xl font-semibold">會議中 (即時)</h3>
              <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
                <li>智慧搜尋 (查資料)</li>
                <li>建議回答</li>
                <li>問題產生</li>
