...
5. **Delegation**
   ...
   | ------------------------ | ------------------------------- | ---------------------------------------- |
   | Deep code insight needed | @agents/core/code-archaeologist | “Need structure overview of X for docs.” |
   | Endpoint details missing | @agents/universal/api-architect | “Provide spec for /v1/payments.”         |
